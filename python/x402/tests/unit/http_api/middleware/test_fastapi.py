"""Unit tests for x402.http_api.middleware.fastapi - FastAPI/Starlette middleware."""
...
from x402.http_api.middleware.fastapi import (
    FastAPIAdapter,
    PaymentMiddlewareASGI,
    _check_if_bazaar_needed,
    payment_middleware,
)
from x402.http_api.types import (
    PaymentOption,
    RouteConfig,
)
...
class TestPaymentMiddleware:
    ...
    async def test_non_protected_route_passes_through(self):
        ...
        with pytest.MonkeyPatch.context() as mp:
            from x402.http_api import middleware as middleware_module
