"""Unit tests for x402.http_api.middleware.flask - Flask WSGI middleware."""
...
from x402.http_api.middleware.flask import (
    FlaskAdapter,
    PaymentMiddleware,
    ResponseWrapper,
...
class TestFlaskMiddlewareIntegration:
    ...
    def test_non_protected_route_passes_through(self):
        ...
        with patch(
            "x402.http_api.middleware.flask.x402HTTPResourceServerSync"
        ) as mock_http_server:
