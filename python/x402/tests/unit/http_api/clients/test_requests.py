"""Unit tests for x402.http_api.clients.requests - requests adapter wrapper."""
...
from x402.http_api.clients.requests import (
...
from x402.http_api.utils import encode_payment_required_header
from x402.http_api.x402_http_client import x402HTTPClientSync
